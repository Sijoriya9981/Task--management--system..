...
{
    $query  = "INSERT INTO task VALUES(NULL, $_POST[id],'$_POST[description]','$_POST[startdate]','$_POST[enddate]','Not Started')";
    ...
    <div class="col-md-4">
      ...
      <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control"name="description" placeholder="Mention the task" id="" rows="5" cols="50" ></textarea>
        </div><br>
        <div class="form-group">
        ...
        <div class="form-group">
        <input type="submit" value="Create" class="btn btn-warning" name= "createtaskbtn">
        </div><br>      
